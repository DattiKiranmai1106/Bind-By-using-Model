		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comsapktbindbindbyusemodel-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapktbindbindbyusemodel-display": {
								"semanticObject": "comsapktbindbindbyusemodel",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.kt.bind.bindbyusemodel",
									"url": sap.ui.require.toUrl("com/sap/kt/bind/bindbyusemodel")
								}
							}
						}
					}
